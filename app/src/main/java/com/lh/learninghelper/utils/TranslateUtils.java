package com.lh.learninghelper.utils;
...
public class TranslateUtils extends AppCompatActivity {
...
//            tip.setText("结束后  "+et_input.getText().toString());
            final int currentFocusId = TranslateUtils.this.getCurrentFocus().getId();
