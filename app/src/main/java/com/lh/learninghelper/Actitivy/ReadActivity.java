...
import com.lh.learninghelper.TopicAdapter;
import com.lh.learninghelper.bean.AnwerInfo;
import com.lh.learninghelper.bean.AnwerInfo.DataBean.SubDataBean;
import com.lh.learninghelper.fragment.ReadFragment;
import com.lh.learninghelper.slidinguppanel.SlidingUpPanelLayout;
import com.lh.learninghelper.slidinguppanel.view.ReaderViewPager;
...
public class ReadActivity extends AppCompatActivity {
    ...
    private List<SubDataBean> datas;
    ...
    private void initReadViewPager() {
        ...
        readerViewPager.setAdapter(new FragmentPagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                SubDataBean subDataBean = datas.get(position);
    ...
    private void initSlidingUoPanel(String title) {
